...
@Component({
  selector: 'app-new-ninja',
  templateUrl: './new-ninja.component.html',
  styleUrls: ['./new-ninja.component.css'],
  providers:[DialogService,MessageService,ConfirmationService]
})
export class NewNinjaComponent implements OnInit{
  ...
  prepareEquipment(){
    ...
    body.ninja.ninjaImage = undefined;
    body.ninja.ninjaStatImage = undefined;
   ...
   /*for (let i = 0; i < this.partes.length; i++) {
    ...
    console.log(body);
    console.log(this.uploadedFiles);
   this.ninjasService.saveNinja(formData).subscribe(
